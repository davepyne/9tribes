...
export type StatName =
  ...
  | 'healOnRetreatAmount' | 'swarmSpeedBonus' | 'sandstormDamage'
  ...
  | 'heavyRetreatDamageReduction' | 'coastalNomadDefense'
  | 'coastalNomadSpeed' | 'heavyNavalRamDamage' | 'slaveHealAmount'
  | 'heavyRegenPercent' | 'terrainSlaveSpeed' | 'sandstormAuraRadius'
