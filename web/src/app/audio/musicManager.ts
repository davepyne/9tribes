...
class MusicManager {
  ...
  private phase: MusicPhase = 'none';
  private gameplayQueue: string[] = [];
  private currentTrack: string | null = null;
  private activationHooksInstalled = false;
  ...
  private installActivationHooks() {
  ...
  private playTrack(src: string, loop: boolean) {
    if (!this.audio) {
      return;
    }
