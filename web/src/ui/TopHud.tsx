...
export function TopHud({ state, turnBanner, onOpenResearch }: TopHudProps) {
  ...
  const [warExhaustionPopup, setWarExhaustionPopup] = useState<boolean>(false);
...
<div
      ...
      {warExhaustionPopup && state.hud.exhaustion && (
        <div className="supply-popup-overlay" onClick={() => setWarExhaustionPopup(false)} style={{ alignItems: 'flex-start' }}>
