...
const FACTION_INFO_MAP: Record<string, FactionInfo> = {
  ...
  river_people: {
    ...
    unitStats: {
      ...
      ability: 'River Stealth: Auto-stealth on river and swamp tiles only (not coast/ocean). +50% ambush damage from stealth. Amphibious: Can emerge from any river hex. Immune to swamp attrition.',
