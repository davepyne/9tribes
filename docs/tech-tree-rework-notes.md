...
- **Fortress native T3 — Bastion placement**: a once-per-game strategic action that converts a hex into a Bastion improvement (+40% def, vision 3 hexes, max 3 per game). Needs a player-action verb, improvement type, and counter.
