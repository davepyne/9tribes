export function parseFreecivGridMainTiles(specText) {
...
export function buildTagFrameLookup(tiles, columns) {
    if (columns <= 0) {
...
export function parseFreecivTagFrameLookup(specText, columns) {
