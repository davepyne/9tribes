...
export function ResearchTab() {
    return (<div className="research-tab">
      <div className="help-content">
        <div className="help-prose" dangerouslySetInnerHTML={{ __html: helpContent.research.body }}/>
      </div>

      <div className="research-tab__pipeline">
        {PIPELINE_STEPS.map((step, i) => (<div key={step.label} className="research-tab__pipeline-segment">
            ...
            {i < PIPELINE_STEPS.length - 1 && (<span className="research-tab__arrow">→</span>)}
          </div>))}
      </div>
    </div>);
}
