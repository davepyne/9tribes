...
export function ResearchNode({ node, selected, onSelect }) {
    ...
    return (<div className={classes} onClick={onSelect} role="button" tabIndex={node.isLocked ? -1 : 0} onKeyDown={(e) => {
      ...
      {node.state === 'completed' && (<div className="research-node__completed-label">Complete</div>)}
