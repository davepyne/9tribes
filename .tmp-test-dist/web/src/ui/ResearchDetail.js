...
export function ResearchDetail({ node, researchRate, onStartResearch, onCancelResearch, hasActiveResearch, activeNodeName, }) {
    if (!node) {
        return (<div className="research-detail research-detail--empty">
    ...
    return (<div className="research-detail">
      ...
      <div className="research-detail__section">
        ...
        {turnsLabel ? (<div className="meta-row">
      ...
      <div className="research-detail__section">
        ...
        <div className="research-detail__req-list">
          ...
          {node.prerequisites.length > 0 ? (<div className="research-detail__req-item research-detail__req-item--met">
      ...
      {node.unlocks.length > 0 ? (<div className="research-detail__section">
          <p className="panel-kicker">Unlocks</p>
          <div className="research-detail__unlock-list">
            {node.unlocks.map((unlock) => (<div key={`${unlock.type}:${unlock.id}`} className="research-detail__unlock-item">
      ...
      {node.qualitativeEffect ? (<div className="research-detail__section">
      ...
      <div className="research-detail__action-row">
        {node.state === 'available' && !hasActiveResearch ? (<button className="research-detail__action research-detail__action--primary" onClick={() => onStartResearch(node.nodeId)}>
            Start Research
          </button>) : node.state === 'active' ? (<button className="research-detail__action research-detail__action--danger" onClick={onCancelResearch}>
            Cancel Research
          </button>) : (<button className="research-detail__action" disabled>
            {buttonLabel}
          </button>)}
