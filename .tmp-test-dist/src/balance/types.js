...
import civsData from '../content/base/civilizations.json' with { type: 'json' };
...
const SIGNATURE_ABILITY_OVERRIDE_KEYS = new Set([
    ...
    'forestHealRate', 'hitAndRun', 'swiftChargeBonus',
...
function assertNoUnknownKeys(scope, value, allowedKeys) {
...
function assertFiniteNumber(scope, value) {
...
export function assertValidBalanceOverrides(overrides) {
    if (!overrides) {
        return;
    }
