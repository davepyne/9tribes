...
import terrainsData from '../../content/base/terrains.json' with { type: 'json' };
import chassisData from '../../content/base/chassis.json' with { type: 'json' };
import componentsData from '../../content/base/components.json' with { type: 'json' };
import veteranLevelsData from '../../content/base/veteran-levels.json' with { type: 'json' };
import improvementsData from '../../content/base/improvements.json' with { type: 'json' };
import researchData from '../../content/base/research.json' with { type: 'json' };
import capabilityDomainsData from '../../content/base/capability-domains.json' with { type: 'json' };
import hybridRecipesData from '../../content/base/hybrid-recipes.json' with { type: 'json' };
import economyData from '../../content/base/economy.json' with { type: 'json' };
import aiProfilesData from '../../content/base/ai-profiles.json' with { type: 'json' };
import signatureAbilitiesData from '../../content/base/signatureAbilities.json' with { type: 'json' };
