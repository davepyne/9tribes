...
export const roleEffectivenessTable = [
...
export function getRoleEffectiveness(attackerRole, defenderRole) {
    const entry = roleEffectivenessTable.find((e) => e.attackerRole === attackerRole && e.defenderRole === defenderRole);
