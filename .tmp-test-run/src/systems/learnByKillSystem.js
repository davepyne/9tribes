...
const LEARN_CHANCE_BY_VETERAN_LEVEL = {
    green: 0.10,
    seasoned: 0.18,
    veteran: 0.24,
    elite: 0.35,
 ...
 */
function calculateLearnChance(veteranLevel) {
 ...
 */
function alreadyHasDomain(learnedAbilities, domainId) {
 ...
 */
export function tryLearnFromKill(attacker, defender, state, rngState, trace) {
