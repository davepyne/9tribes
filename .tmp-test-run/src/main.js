...
import { createSimulationTrace, runWarEcologySimulation, summarizeFaction, } from './systems/warEcologySimulation.js';
const SEED = 42;
const MAX_TURNS = 50;
function printMapSummary(map) {
    const terrainCounts = {};
...
function main() {
    ...
    printMapSummary(initialState.map);
    console.log('\nInitial factions');
